...
describe('CreateRecordComponent', () => {
  ...
  let mockCreateRecordService;
  let mockDataService

  beforeEach(async(() => {

    mockCreateRecordService = sinon.createStubInstance(CreateRecordService);
    mockCreateRecordService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: CreateRecordService, useValue: mockCreateRecordService },
