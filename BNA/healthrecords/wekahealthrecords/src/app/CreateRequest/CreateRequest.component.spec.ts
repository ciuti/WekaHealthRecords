...
describe('CreateRequestComponent', () => {
  ...
  beforeEach(async(() => {
    ...
    mockCreateRequestService = sinon.createStubInstance(CreateRequestService);
    mockCreateRequestService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: CreateRequestService, useValue: mockCreateRequestService },
